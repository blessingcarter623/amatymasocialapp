...
// Sample merchandise data (same as in Merchandise.tsx)
const MERCHANDISE_DATA: Product[] = [
  {
    id: "1",
    name: "Amatyma Brotherhood T-Shirt",
    description: "Official Amatyma Brotherhood Circle T-shirt with logo on front. Made from premium quality cotton for maximum comfort and durability. This T-shirt features the iconic Amatyma Brotherhood Circle logo on the front chest area and a small logo on the back. Perfect for casual wear and showing your support for the brotherhood.",
    price: 349,
    image: "/lovable-uploads/2b1b2f71-b5bc-4ead-a07b-810597474e21.png",
    category: "Clothing",
